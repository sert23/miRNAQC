...
from .plots import ajax_boxplots, ajax_PCA, ajax_PCs
...
urlpatterns = [
    ...
    url(r'^ajax_bp$', ajax_boxplots, name='ajax_bp'),
    url(r'^ajax_pca$', ajax_PCA, name='ajax_pca'),
    url(r'^ajax_pcs$', ajax_PCs, name='ajax_pcs'),
